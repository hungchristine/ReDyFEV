...
# Refactor retrieved data to dataframes for calculations
# Handle missing data
# Export
...
def fetch_generation():
    ...
    with open('entso_export_gen_final.pkl', 'wb') as handle:
...
def fetch_trade():
    ...
    with open('entso_export_trade_final.pkl', 'wb') as handle:
